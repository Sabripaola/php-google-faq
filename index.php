    ...
    <div class="container">
      <div class="nav">
        ...
        <div class="secondo">
          <ul>
            ...
            <li><a class="line" href="#">Domande frequenti</a></li>
      ...
      <div class="faq">
        <?php
          $faq = [
            [
              'dom' => 'How are you implementing the recent Court of Justice of the European Union (CJEU) decision on the right to be forgotten?',
              'risp' =>'The recent ruling by the Court of Justice of the European Union has profound consequences for search engines in Europe. The court found that certain users have the right to ask search engines like Google to remove results for queries that include the person's name. To qualify, the results shown would need to be inadequate, irrelevant, no longer relevant, or excessive.',
            ...
            [
              'dom' => 'How does Google protect my privacy and keep my information secure?',
              'risp' =>'We know security and privacy are important to you – and they are important to us, too. We make it a priority to provide strong security and give you confidence that your information is safe and accessible when you need it.',
          ...
          foreach ($faq as $value) {
            ...
            foreach ($risposta as $int) {
              ?> <p><?php echo $int; ?></p>  <?php
            }
          }
           ?>
